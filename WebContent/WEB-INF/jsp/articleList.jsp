...
<title>${arcType.typeName }_JeeCms内容管理系统-宜春春宜人网络科技有限公司</title>
	...
	<div class="content">
		<div class="w960">
			<div class="pLeft">
							...
							<c:forEach var="article" items="${articleList }">
								<li><a target="_blank"
									...
									title="${article.title }">[<fmt:formatDate
										...
										<font color="${article.titleColor }">${fn:substring(article.title,0,20) }</font></a>
								</li>
							</c:forEach>
						</ul>
					</div>
				...
				<div class="upAndDownPage">${pageCode }</div>
